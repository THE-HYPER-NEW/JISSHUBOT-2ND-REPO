...
async def pm_search(client, message):
 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url='https://t.me/MOVIE_SEARCHING_GROUP_ACX')]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAEBTxtoOIU0zS4G_1y3FmDswhXhXVVOuAACnhAAAn8WWFeT1TSYg_i9KzYE") 
        await m.delete()
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/ACX_OWNER_DM_ROBOT')
        ],[
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
          ...
          media=InputMediaAnimation(
            media="https://cdn.jsdelivr.net/gh/THEHYPER_ACX/HYPER_BOTS/Video.mp4/Welcome_video_20240921_184741_0001.gif",
       ...
       await client.edit_message_media(
        ...
        await query.message.edit_text(
			...
			InlineKeyboardButton('Sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', callback_data='SourceDm')
                ],[
    ...
    elif query.data == "SourceDm":
        buttons = [[
            InlineKeyboardButton('Repo', url='https://t.me/ACX_OWNER_DM_ROBOT')
        ],[
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/ACX_DISCUSSION'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
          message_id=query.message.id,
          media=InputMediaAnimation(
            media="https://cdn.jsdelivr.net/gh/ACXBOTZ_UPDATE/THEHYPER_ACX/Video.mp4/Group_20240921_202540_0001.gif",
