...
auth_channel = environ.get('AUTH_CHANNEL', '-1002467015295 -1002326594935 -1002348758566')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ACX_MOVIE_GROUP') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '6000'))
...
DELETE_TIME = int(environ.get('DELETE_TIME', 12000))
